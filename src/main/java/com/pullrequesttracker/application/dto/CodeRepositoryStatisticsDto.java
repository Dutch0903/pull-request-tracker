...
public record CodeRepositoryStatisticsDto(UUID codeRepositoryId,
        PullRequestStatisticsDto pullRequestStatistics,
        ContinuousIntegrationStatisticsDto continuousIntegrationStatistics,
